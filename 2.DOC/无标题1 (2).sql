...
insert into tbl_student values('s006', '张三丰', 'cr03')
insert into tbl_student values('s007', '%!张三丰', 'cr03')
...
select s.sname as 学生, c.sname as 课程, score as 成绩, avg as 平均分 from tbl_student as s, tbl_course as c, 
(
	select *from 
	(
...
select *from tbl_student where sname like '[张,李]__'
